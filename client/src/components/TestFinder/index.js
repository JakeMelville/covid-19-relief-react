        ...
        <div>
            <div className='pic bg-image'>
                ...
                <div className='row text-left pl-5 justify-content-center'>
                    <ul className='col-5'>
                        <li className='p-2 row'>{props.testingSite1}</li>
                        <button id='contactBtn' type='button' className='float-left btn btn-small btn-outline-info' onClick={props.showModal}>Contact</button>
                        <button id='saveBtn' type='button' className="btn btn-small btn-primary" onClick={props.saved}>Save</button>
