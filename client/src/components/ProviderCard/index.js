            ...
            <div className='row justify-content-between'>
                ...
                <div id='brandNameCard0' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brandWebsite} target='_blank' rel="noopener noreferrer" className="card-link">{props.brandWebsite}</a>
                    </div>
                </div>
                <div id='brandNameCard1' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand1Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand1Website}</a>
                    </div>
                </div>
                <div id='brandNameCard2' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand2Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand2Website}</a>
                    </div>
                </div>
                <div id='brandNameCard3' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand3Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand3Website}</a>
                    </div>
                </div>
                <div id='brandNameCard4' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand4Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand4Website}</a>
                    </div>
                </div>
                <div id='brandNameCard5' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand5Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand5Website}</a>
                    </div>
                </div>
                <div id='brandNameCard6' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand6Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand6Website}</a>
                    </div>
                </div>
                <div id='brandNameCard7' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand7Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand7Website}</a>
                    </div>
                </div>
                <div id='brandNameCard8' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand8Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand8Website}</a>
                    </div>
                </div>
                <div id='brandNameCard9' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand9Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand9Website}</a>
                    </div>
                </div>
                <div id='brandNameCard10' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand10Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand10Website}</a>
                    </div>
                </div>
                <div id='brandNameCard11' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand11Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand11Website}</a>
                    </div>
                </div>
                <div id='brandNameCard12' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand12Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand12Website}</a>
                    </div>
                </div>
                <div id='brandNameCard13' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand13Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand13Website}</a>
                    </div>
                </div>
                <div id='brandNameCard14' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand14Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand14Website}</a>
                    </div>
                </div>
                <div id='brandNameCard15' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand15Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand15Website}</a>
                    </div>
                </div>
                <div id='brandNameCard16' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand16Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand16Website}</a>
                    </div>
                </div>
                <div id='brandNameCard17' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand17Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand17Website}</a>
                    </div>
                </div>
                <div id='brandNameCard18' className="card col-6 mb-1">
                    <div className="card-body">
                        ...
                        <a href={props.brand18Website} target='_blank' rel="noopener noreferrer" className="card-link">{props.brand18Website}</a>
                    </div>
                </div>
            </div>
        </div>
